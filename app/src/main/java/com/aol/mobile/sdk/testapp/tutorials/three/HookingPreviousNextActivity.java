...
public class HookingPreviousNextActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        playerFragment.getBinder().setFeedbackHandler(new DefaultFeedbackHandler(){
            public void onButtonClick(Player player, ContentControls.Button button) {
                switch (button){
                    case PREVIOUS:
                        Toast.makeText(getApplicationContext(), R.string.previous_video, Toast.LENGTH_SHORT).show();
                        break;
                    case NEXT:
                        Toast.makeText(getApplicationContext(), R.string.next_video, Toast.LENGTH_SHORT).show();
                        break;
                }
